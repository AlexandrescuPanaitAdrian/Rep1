...
# Functia range(x) ne ofera, pe rand, toate numerele de la 0 la x - 1 inclusiv si permite inlocuirea elementelor
...
"""
Putem declara indexul din for si inaintea for-ului, 
dar aceasta va fi suprascris cu ultima valoare obtinuta din for.
"""
x = 0
print(f"X este acum {x}")
x = 1
